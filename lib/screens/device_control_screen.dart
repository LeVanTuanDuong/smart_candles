...
import '../widgets/temperature_status_widget.dart';
...
class _DeviceControlScreenState extends State<DeviceControlScreen> {
  ...
  Widget _buildLightModeButton(
    ...
    final isSelected = _deviceStatus.lightMode == mode && _deviceStatus.isLightOn;
    return InkWell(
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            SwitchListTile(
              title: Text(
                _deviceStatus.isMusicPlaying ? 'Nhạc đang phát' : 'Nhạc đang tắt',
                style: const TextStyle(fontWeight: FontWeight.w600),
              ),
