...
import 'package:smart_candles/features/mood_journal/presentation/screens/mood_journal_screen.dart';
import 'package:smart_candles/features/device/presentation/screens/safety_history_screen.dart';
import 'package:smart_candles/features/music/presentation/screens/meditation_guide_screen.dart';
import 'package:smart_candles/features/music/presentation/screens/music_library_screen.dart';
...
class _DashboardHomeScreenState extends State<DashboardHomeScreen> {
  ...
  // Helper method to get default music suggestion
  String _getDefaultMusicSuggestion(MoodType mood) {
    switch (mood) {
  ...
  // Helper method to get default light suggestion
  String _getDefaultLightSuggestion(MoodType mood) {
    switch (mood) {
      case MoodType.stressed:
        return 'warm';
      case MoodType.sad:
  ...
  Future<void> _updateSuggestedMusicTrack() async {
    try {
      ...
      final musicType = _suggestionService.musicSuggestion ??
          _getDefaultMusicSuggestion(currentMood);
  ...
  void _handleMoodSelected(MoodType mood) {
    ...
    setState(() {
      ...
      final lightMode = _getDefaultLightSuggestion(mood);
      final suggestedMusic = _suggestionService.musicSuggestion ??
          _getDefaultMusicSuggestion(mood);
      _deviceStatus = _deviceStatus.copyWith(
        isLightOn: true,
        lightMode: lightMode,
